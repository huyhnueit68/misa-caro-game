 ...
 */
const checkColumnWin = (board, row, col, turn_text) => {
 ...
 * CreatedBy: PQ Huy (26.07.2021)
 */
const checkRowWin = (board, row, col, turn_text) => {
    // init piece col and row
    let piece_win = [],
        index = col - 1,
        indexBefore = 0,
 ...
 * CreatedBy: PQ Huy (26.07.2021)
 */
const checkDialognalLeft = (board, row, col, turn_text) => {
    // init piece col and row
    let piece_win = [],
        row_index = row - 1,
        col_index = col - 1,
 ...
 * CreatedBy: PQ Huy (26.07.2021)
 */
const checkDialognalRight = (board, row, col, turn_text) => {
    // init piece col and row
    let piece_win = [],
        row_index = row - 1,
        col_index = col + 1,
 ...
 * CreatedBy: PQ Huy (26.07.2021)
 */
export const CheckedWinner = (board, row, col, turn) => {
     ...
     */
    piece_win = checkColumnWin(board, row, col, turn_text)
     ...
     */
    piece_win = checkRowWin(board, row, col, turn_text)
    if (piece_win.length > 0)
        return piece_win;
     ...
     */
    piece_win = checkDialognalLeft(board, row, col, turn_text)
    if (piece_win.length > 0)
        return piece_win;
     ...
     */
    piece_win = checkDialognalRight(board, row, col, turn_text)
    if (piece_win.length > 0)
        return piece_win;
